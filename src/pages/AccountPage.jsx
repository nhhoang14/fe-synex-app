            ...
            <div className="max-h-[60vh] overflow-y-auto p-6 space-y-6">
              ...
              <div className="rounded-2xl border border-border bg-slate-50 p-4 space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-ink">{(displayOrder.subTotal || 0).toLocaleString('vi-VN')} đ</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-slate-500 font-medium">Phí vận chuyển:</span>
                  <span className="font-bold text-ink">{(displayOrder.shippingFee || 0).toLocaleString('vi-VN')} đ</span>
                </div>
                {(displayOrder.discountAmount > 0 || displayOrder.voucherCode) && (
                  <div className="flex justify-between text-sm text-sky-700">
                    ...
                    <span className="font-bold">- {(displayOrder.discountAmount || 0).toLocaleString('vi-VN')} đ</span>
                  </div>
                )}
                <div className="pt-2 border-t border-slate-200 flex justify-between items-center">
                  ...
                  <strong className="text-xl font-bold text-red-600">
                    {(displayOrder.totalAmount || 0).toLocaleString('vi-VN')} đ
                  </strong>
                </div>
              </div>
            </div>
